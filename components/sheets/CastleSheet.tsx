  ...
  return (
    <div className="flex flex-col h-full">
      <div className="px-4 py-3 border-b border-gray-100">
        <p className="font-bold text-gray-700 text-sm">🏰 積みゲー城</p>
      </div>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-3xl font-bold text-purple-600">{clearRate}%</p>
              <p className="text-sm text-gray-400 mt-1">消化率</p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="bg-purple-50 rounded-xl p-3 text-center">
                ...
                <p className="text-xs text-gray-500 mt-0.5">積みゲー</p>
              </div>
              <div className="bg-blue-50 rounded-xl p-3 text-center">
                <p className="text-2xl font-bold text-blue-500">{playing}</p>
                <p className="text-xs text-gray-500 mt-0.5">プレイ中</p>
              </div>
              <div className="bg-green-50 rounded-xl p-3 text-center">
                <p className="text-2xl font-bold text-green-500">{cleared}</p>
                <p className="text-xs text-gray-500 mt-0.5">クリア済み</p>
              </div>
            </div>
