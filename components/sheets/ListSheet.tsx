  ...
  return (
    <div className="flex flex-col h-full">
      <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
        <p className="font-bold text-gray-700 text-sm">📋 積みゲーリスト</p>
        <span className="text-xs text-gray-400">{games.length} 本</span>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        {loading ? (
          ...
          <p className="text-center text-gray-400 text-sm pt-10">ゲームが登録されていません</p>
        ) : (
              ...
              <li key={game.id}>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-gray-800 truncate">{game.title}</p>
                    <p className="text-xs text-gray-400">{game.platform ?? 'プラットフォーム未設定'}</p>
                  </div>
